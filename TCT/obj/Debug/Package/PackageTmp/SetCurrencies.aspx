...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource_Currency" runat="server" 
        ...
        SelectCommand="SELECT CurrencyID, Name, Code FROM PurchaseOrder.Currency ORDER BY Name" 
        InsertCommand="INSERT INTO PurchaseOrder.Currency (Name, Code) VALUES (@Name, @Code)" 
        UpdateCommand="UPDATE PurchaseOrder.Currency SET Name = @Name, Code = @Code WHERE CurrencyID = @CurrencyID"
