    ...
    <tr>
        <td style="width: 280px; vertical-align: top;">
            ...
            <asp:SqlDataSource ID="SqlDataSource_ListBox1" runat="server" CancelSelectOnNullParameter="False"
                ...
                <SelectParameters>
                    ...
                    <asp:Parameter Name="NumOfDays" DefaultValue="30" Type="Int32" />
        ...
        <td style="vertical-align: top;">
            ...
            <asp:SqlDataSource ID="SqlDataSource_DeliveryHeader_TotalPackageCount" runat="server" 
                ConnectionString="<%$ ConnectionStrings:CustomsToolConnectionString %>" 
                UpdateCommand="UPDATE Delivery.DeliveryHeader SET TotalPackageCount = (SELECT SUM(PackageCount) AS Expr1 FROM Delivery.DeliveryLine WHERE (DeliveryID = @DeliveryID)) WHERE (DeliveryID = @DeliveryID)">
                <UpdateParameters>
                    <asp:ControlParameter Name="DeliveryID" ControlID="ListBox1" PropertyName="SelectedValue" />
                </UpdateParameters>
            </asp:SqlDataSource>
            ...
            <asp:GridView ID="GridViewDeliveryLines" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Incoterm" HeaderText="Incoterm" meta:resourcekey="DLinesGVIncotermResource1" />
                    <asp:BoundField DataField="GrossWeight" HeaderText="Gross Weight" meta:resourcekey="DLinesGVGrossWeightResource1">
                        <ControlStyle Width="80px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="PackageCount" HeaderText="Packages" meta:resourcekey="DLinesGVPackagesResource1" />
            ...
            <asp:SqlDataSource ID="SqlDataSource_DeliveryLines" runat="server" 
                ConnectionString="<%$ ConnectionStrings:CustomsToolConnectionString %>" 
                SelectCommand="SELECT d.DeliveryLineID, d.DeliveryID, d.SupplierID, s.Name, d.CountryOfDispatch, d.Incoterm, d.FreightBillNumber, d.GrossWeight, d.PackageCount, d.Comment, count(a.AttachmentID) Attachments 
                    ...
                    GROUP BY d.DeliveryLineID, d.DeliveryID, d.SupplierID, s.Name, d.CountryOfDispatch, d.Incoterm, d.FreightBillNumber, d.GrossWeight, d.PackageCount, d.Comment">
                <SelectParameters>
                    <asp:ControlParameter Name="DeliveryID" ControlID="ListBox1" PropertyName="SelectedValue" />
                </SelectParameters>
            </asp:SqlDataSource>
            ...
            <asp:FormView ID="FormViewDeliveryLine" runat="server" DefaultMode="Edit" DataSourceID="SqlDataSource_DeliveryLine" DataKeyNames="DeliveryLineID" 
                ...
                <EditItemTemplate>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr><td><asp:Label ID="DLineFVPackageCountLabel" runat="server" Text="Number of Packages:" meta:resourcekey="DLineFVPackageCountLabelResource1" /></td>
                            <td>
                                <asp:TextBox ID="PackageCountTextBox" runat="server" Text='<%# Bind("PackageCount") %>' CssClass="grey" />
                                <asp:RequiredFieldValidator ID="ReqFieldValidatorPackages" runat="server" ErrorMessage="* Required field"
                                ...
                                <asp:RegularExpressionValidator ID="RegExValidatorPackages" runat="server" ErrorMessage="* Please insert a number"
                                    ControlToValidate="PackageCountTextBox" ValidationGroup="EditDeliveryLine" 
                        ...
                        <tr><td><asp:Label ID="DLineFVCommentLabel" runat="server" Text="Comment:" meta:resourcekey="DLineFVCommentLabelResource1" /></td>
                            <td>
                                <asp:TextBox ID="CommentTextBox" runat="server" Text='<%# Bind("Comment") %>' CssClass="grey" />
                            </td>
                        </tr>
                ...
                <InsertItemTemplate>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr><td><asp:Label ID="DLineFVPackageCountLabel" runat="server" Text="Number of Packages:" meta:resourcekey="DLineFVPackageCountLabelResource1" /></td>
                            <td><asp:TextBox ID="PackageCountTextBox" runat="server" Text='<%# Bind("PackageCount") %>' CssClass="grey" />
                                <asp:RequiredFieldValidator ID="ReqFieldValidatorPackages" runat="server" ErrorMessage="* Required field"
            ...
            <asp:SqlDataSource ID="SqlDataSource_DeliveryLine" runat="server" 
                ConnectionString="<%$ ConnectionStrings:CustomsToolConnectionString %>" 
                SelectCommand="SELECT DeliveryLineID, SupplierID, FreightBillNumber, GrossWeight, CountryOfDispatch, Incoterm, PackageCount, Comment 
                    FROM Delivery.DeliveryLine WHERE DeliveryLineID = @DeliveryLineID" 
                UpdateCommand="UPDATE Delivery.DeliveryLine SET SupplierID = @SupplierID, FreightBillNumber = @FreightBillNumber, GrossWeight=REPLACE(@GrossWeight, ',', '.'), 
                    CountryOfDispatch = @CountryOfDispatch, Incoterm = @Incoterm, PackageCount = @PackageCount, Comment = @Comment, LastUpdateDate = GETDATE(), LastUpdateUserID = @UserId 
                    WHERE DeliveryLineID = @DeliveryLineID"
                InsertCommand="INSERT INTO Delivery.DeliveryLine(DeliveryID, SupplierID, FreightBillNumber, GrossWeight, CountryOfDispatch, Incoterm, PackageCount, Comment, CreateUserID) 
                    VALUES (@DeliveryID, @SupplierID, @FreightBillNumber, REPLACE(@GrossWeight, ',', '.'), @CountryOfDispatch, @Incoterm, @PackageCount, @Comment, @UserId)">
                <SelectParameters>
                ...
                <UpdateParameters>
                    ...
                    <asp:Parameter Name="PackageCount" />
