...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridViewSupplier" runat="server" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" GridLines="None" 
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:CheckBox ID="IsUrgentCheckBox" runat="server" Checked='<%# Eval("IsUrgent").ToString().Equals("1") ?  true : false %>'/>                
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource_Supplier" runat="server" 
        ...
        SelectCommand="SELECT s.SupplierID, s.Name, count(d.DeliveryID) Usage, s.IsUrgent
            FROM Delivery.Supplier s LEFT JOIN Delivery.DeliveryLine d ON s.SupplierID = d.SupplierID 
            GROUP BY s.SupplierID, s.Name, s.IsUrgent ORDER BY s.Name" 
        InsertCommand="INSERT INTO Delivery.Supplier (Name) VALUES (@Name)" 
        UpdateCommand="UPDATE Delivery.Supplier SET Name = @Name, IsUrgent = @IsUrgent WHERE SupplierID = @SupplierID"
